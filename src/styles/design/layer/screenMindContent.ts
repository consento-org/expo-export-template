...
export const screenMindContent = {
  ...
  layers: {
    ...
    ok: new LayerPlacement(elementButton, { x: 10.5, y: 283, w: 265, h: 80, r: 99.5, b: 449 }, {}),
    header: new LayerPlacement(elementHeader, { x: 0, y: 0.85, w: 376, h: 117, r: -1, b: 694.1481365588734 }, {}),
    popup: new LayerPlacement(elementPopup, { x: 63.75, y: 340, w: 248.5, h: 132, r: 62.75, b: 340 }, {
      outputJa: 'こんにちは！',
      outputEn: 'Hello World!'
    })
  }
}
