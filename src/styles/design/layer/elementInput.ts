...
export const elementInput = {
  ...
  layers: {
    ...
    inputEn: new TextBox('Input here', TextStyles.EnInput, { x: 10, y: 9, w: 355, h: 53, r: 10, b: 0 }),
    inputJa: new TextBox('入力して下さい', TextStyles.JaInput, { x: 10.25, y: 4, w: 355, h: 53, r: 9.75, b: 5 })
  }
}
